...
export const photoVersions = sqliteTable("photo_versions", {
...
export const googleAuthorizations = sqliteTable("google_authorizations", {
...
export const plusOnes = sqliteTable("plus_ones", {
  ...
  userIdPhotoIdIdx: index("idx_plus_ones_user_photo").on(table.userId, table.photoId),
